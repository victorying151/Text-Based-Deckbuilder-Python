...
card_pool = [draw_strike, quick_strike, inflame, poison, armour_up, twin_strike, heal, draw, power_through, fumes, catalyst, blade_dance, cloak, dagger]
...
corrupt_heart.set_health(25000)
...
''')
                ...
                print('You have beaten the game! I suppose you should go play again, and see if you can get something else. Who knows!')
                print('You do not get anything. Even if you did, you cannot use it anymore anyways.')
                print('Right you still get gold from your piggy banks')
                for i in bag:
                    if i == piggy_bank:
                        gold += 10
                        print('You find 10 gold in your piggy bank. Yay!')
                exit()
